/*
  # Fix user settings and recurring expenses validation
...
-- Create function to clean recurring expense data
...
-- Create function to trim strings
...
-- Create trigger for string trimming
